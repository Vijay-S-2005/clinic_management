...
export default function Inventory() {
  const [noOfMedicines, setNoOfMedicines] = useState(0); // Initialize as a number
  ...
  useEffect(() => {
    const fetchMedicinesList = async () => {
      try {
        ...
        // Assuming the response format is { message: '...', data: { count: ... } }
        setNoOfMedicines(response.data.data.count);
      } catch (error) {
      ...
      <div className="flex-1 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-blue-500">
            ...
            <button
              onClick={() => router.push("/medicinelist")}
