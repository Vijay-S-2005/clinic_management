...
export default function Addmedicine() {
    ...
    const medicineGroups = ['Generic Medicine', 'Diabetes', 'Pain Relief', 'Vitamins', 'Antibiotics'];
            ...
            <div className="w-full max-w-2xl p-6 bg-white rounded-lg shadow-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Strength (e.g., 500 mg)</label>
                            <input
                                type="text"
                                value={strength}
